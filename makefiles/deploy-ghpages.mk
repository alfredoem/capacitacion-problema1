...
BUILD_DIR = build
GIT_BRANCH = gh-pages
GIT_PERSONAL_TOKEN = a20d15f649b72d92e8e603a93ebc1aa4c61fb9a3
GIT_BRANCH_DIR = $(PWD)/app/$(DEPLOY_DIR)/$(GIT_BRANCH)/
...
define copy_files_to_deploy
    @cp -r $(PWD)/app/$(DEPLOY_DIR)/$(BUILD_DIR)/* $(GIT_BRANCH_DIR)
endef
